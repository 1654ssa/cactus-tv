...
try {
  ...
  for (const ref of ['/styles.css?v=1.2.2', '/js/app.js?v=1.2.2']) {
...
try {
  ...
  for (const token of ['applyCleanStream', "import('./player.js?v=1.2.2')", "import('./player-ui.js?v=1.2.2')", 'buildPersonalizedHome']) {
